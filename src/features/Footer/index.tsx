        ...
        <>
            ...
            <Link to="main" smooth>
                ...
                <nav className={styles.footer_pc__nav}>
                    <Link to="main" smooth className={styles.footer_pc__nav__link}>
                        Главная
                    </Link>
                    <Link to="about" smooth className={styles.footer_pc__nav__link}>
                        О Компании
                    </Link>
                    <Link to="services" smooth className={styles.footer_pc__nav__link}>
                        Услуги
                    </Link>
                    <Link to="contacts" smooth className={styles.footer_pc__nav__link}>
                        Контакты
                    </Link>
                </nav>
                <ModalWhite
